    ...
    public class DBManager
    {
        ...
        public static void SeedData()
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                ...
                var users = new[]
                {
                    new { Name = "John Doe", Username = "john_doe", Email = "john@example.com", Address = "123 Elm St", Phone = "123-456-7890", Picture = "pic1.jpg", Password = "password1", Role = "Admin" },
                    new { Name = "Jane Smith", Username = "jane_smith", Email = "jane@example.com", Address = "456 Oak St", Phone = "987-654-3210", Picture = "pic2.jpg", Password = "password2", Role = "Admin" },
                ...
                foreach (var user in users)
                {
                    ...
                    {
                        new { TransactionType = "Deposit", Amount = new Random().Next(100, 1000), TransactionDate = DateTime.UtcNow.ToString("o") },
                        new { TransactionType = "Withdrawal", Amount = new Random().Next(100, 1000), TransactionDate = DateTime.UtcNow.AddDays(-5).ToString("o") }
                    };
